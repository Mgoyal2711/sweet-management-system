...
Lines: 17/17 (100%)
Test Files Coverage:
SweetShop.addSweet.test.ts - Tests for adding sweets
SweetShop.deleteSweet.test.ts - Tests for deleting sweets
SweetShop.seacrhByName.test.ts - Tests for name search
SweetShop.searchByCategory.test.ts - Tests for category search
SweetShop.searchByPrice.test.ts - Tests for price range search
SweetShop.purchase.test.ts - Tests for purchasing functionality
SweetShop.restock.test.ts - Tests for restocking functionality
IdGenerator.test.ts - Tests for ID generation utility
View detailed coverage report: Open Backend/coverage/index.html in your browser after running tests.
...
🎯 Business Logic
The SweetShop class implements all core functionality:
...
Unique ID Generation: Using generateSweetId()
🤝 Contributing
Step 1: Fork and Clone
# Fork the repository on GitHub first, then clone your fork
git clone https://github.com/your-username/Sweet-management-system.git
